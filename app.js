...
const { CARD_RARITY, RARITY_ORDER } = module6;
...
return {clone,random,shuffle,instance,SEASON_EVENTS,offers,RARITY_ODDS,SHOP_PRICE_RANGE,rarityChances,rarityOffers,shopPrice,createRun,createSeason,startBattle,drawCards,damage,intent,intentText,canPlay,removalReason,healAmount,act,replay,preview,legalActions,observe};
})();
const module8=(()=>{
...
const { playSfx, soundForAction, soundForCard } = module13;
const { snapshotWa, diffCombat, playFeedback, cardSlam } = module14;
...
const module16=(()=>{
// combat-fx.js
const { waHit } = module15;
const { playSfx } = module13;
...
const { clearCombatFx, captureCombatStage, playCombatFx } = module16;
...
const { statusBadges, statusIcon, highlightKeywords } = module20;
const { createRun, canPlay, preview, intent, intentText, healAmount, removalReason, observe, shopPrice } = module7;
const { CARD_RARITY, RARITY_LABELS } = module6;
const { createWaSeason, waAct:act, waLegalActions:legalActions } = module17;
const { syncWaCheckpoint } = module18;
const { flyCardsFromPile, flyCardsToPile } = module19;
const { soundToggleHtml } = module13;
const { waJuiceAction, waSlam } = module15;
